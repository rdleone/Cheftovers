...
fun recipeSample(): Recipe {
    return Recipe(
        ...
        desc = "This simple classic chicken noodle soup can be made in a crock pot or on the stove-top—get a great homemade taste with this Betty Crocker inspired recipe. Bring on the cold weather; I'm ready now.\n" +
                "This is a four to six serving recipe. You can cut in half easily, but you want a few leftovers.",
        ingr = listOf("2 skinless boneless chicken breasts", "32-48 oz chicken broth",
